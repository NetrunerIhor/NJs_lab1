function triangle(arg1, argType1, arg2, argType2) {
  if ((argType1 != ('leg'||'hypotenuse'||'adjacent angle'||'opposite angle'||"angle")) || (argType2 != ('leg'||'hypotenuse'||'adjacent angle'||'opposite angle'||"angle"))){
  ...
  if (argType1 == "leg" && argType2 == "leg") {
    ...
    const alpha = Math.atan(arg1 / arg2);
    const beta = Math.atan(arg2 / arg1);
    console.log("a = " + arg1);
    console.log("b = " + arg2);
    console.log("c = " + h);
    ...
    const c = arg2 / Math.cos(arg1);
    const a = arg2 * Math.tan(arg1);
    const beta = 90 - arg1;
    console.log("a = " + a);
    console.log("c = " + c);
    console.log("b = " + arg2);
    ...
    const c = arg1 / Math.cos(arg2);
    const b = arg1 * Math.tan(arg2);
    const alpha = 90 - arg2;
    console.log("a = " + arg1);
    console.log("b = " + b);
    console.log("c = " + c);
    ...
    arg1 = arg1 * (Math.PI / 180);
    const beta = 90 - arg1;
    const a = arg2 * Math.sin(arg1);
    const b = arg2 * Math.cos(arg1);
    console.log("a = " + a);
    console.log("b = " + b);
    console.log("c = " + arg2);
    console.log("alpha = " + arg1);
    ...
    arg2 = arg2 * (Math.PI / 180);
    const alpha = 90 - arg2;
    const a = arg1 * Math.cos(arg2);
    const b = arg1 * Math.sin(arg2);
    console.log("a = " + a);
    console.log("b = " + b);
    console.log("c = " + arg1);
    console.log("alpha = " + alpha);
